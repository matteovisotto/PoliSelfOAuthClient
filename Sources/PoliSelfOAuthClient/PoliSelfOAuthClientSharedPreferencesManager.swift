...
class PoliSelfOAuthClientSharedPreferencesManager {
    ...
    public static func setRestAccessToken(accessToken: String) {
        UserDefaults.standard.set(accessToken, forKey: "poliselfoauthclient.pref.rest.access_token")
    }
    
    public static func setRestRefreshToken(refreshToken: String) {
        UserDefaults.standard.set(refreshToken, forKey: "poliselfoauthclient.pref.rest.refresh_token")
    }
    ...
    public static func isRestUserLogged() -> Bool {
        return !(UserDefaults.standard.string(forKey: "poliselfoauthclient.pref.rest.access_token") == nil ? true : false)
    }
    ...
    public static func getRestAccessToken() -> String? {
        return UserDefaults.standard.string(forKey: "poliselfoauthclient.pref.rest.access_token")
    }
    
    public static func getRestRefreshToken() -> String? {
        return UserDefaults.standard.string(forKey: "poliselfoauthclient.pref.rest.refresh_token")
    }
    ...
    public static func deletePreferences() {
        ...
        UserDefaults.standard.removeObject(forKey: "poliselfoauthclient.pref.rest.refresh_token")
        UserDefaults.standard.removeObject(forKey: "poliselfoauthclient.pref.rest.access_token")
    }
}
